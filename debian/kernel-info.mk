...
# Kernel base version
KERNEL_BASE_VERSION = 3.10.108

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = androidboot.hardware=qcom ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 ramoops_memreserve=4M loop.max_part=7 androidboot.selinux=permissive buildvariant=userdebug androidboot.emmc=true androidboot.boardID=2 androidboot.fpsensor=gdx androidboot.keymaster=1 androidboot.serialno=eeabee3d androidboot.baseband=msm mdss_mdp.panel=1:dsi:0:qcom,mdss_dsi_boe_nt35532_1080p_video:1:none:cfg:single_dsi console=/dev/tty0 droidian.lvm.prefer
...
DEVICE_FULL_NAME = Xiaomi Redmi Note 3
...
# recommended.
FLASH_INFO_CPU = Qualcomm Technologies, Inc MSM8956

# Space-separated list of supported device ids as reported by fastboot
FLASH_INFO_DEVICE_IDS = kenzo kate
